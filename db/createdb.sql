...
CREATE TABLE bookings( booking_id INT (255) Primary key AUTO_INCREMENT, pass_name VARCHAR (255) Not null , pass_IDPASS VARCHAR (255) Not null , ticket_numbers INT (255) Not null , ticket_type VARCHAR (255) Not null , train_from VARCHAR (255) Not null, train_to VARCHAR (255) Not null, time_dept TIME (6) Not null, time_arr TIME (6) Not null, day_travel Date Not null);
-- Insertions
